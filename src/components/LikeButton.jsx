...
import { getCountLike, getLikesForUser, searchTweetsForId } from "../helpers"
...
export function LikeButton ({ id }) {
    ...
    // COMPROBANDO SI EL TWEET PERMANENCE EN LIKE PARA MANTENERLO PINTADO
    const infLikesForUser = getLikesForUser(user, favoriteCounter); // retorna las coincidencias de like con user
    const tweetsIdsArray = searchTweetsForId(infLikesForUser); // retorna los ID de tweets del usuario
    const statusIdTweet = tweetsIdsArray?.find((element) => element === id); // me retorna SI esta un ID o no
