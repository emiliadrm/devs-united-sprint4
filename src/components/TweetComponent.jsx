...
function TweetComponent({ tweetMensaje, id, likes, photo, username, color, uid }) {
    ...
    const deleteTweet = (id) => {
        firestore.doc("tweets").doc(id).delete();
    };
